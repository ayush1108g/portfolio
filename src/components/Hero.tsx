      ...
      <div className="container mx-auto px-4 md:px-8 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Hi, I&apos;m <br />
            <span className="text-gradient">Ayush Gupta</span>
          </h1>
          <p className="text-xl text-slate-400 mb-8 max-w-lg leading-relaxed">
            Software developer and competitive programmer building practical
            products with{" "}
          ...
          <div className="w-full h-[500px] border border-slate-800 bg-slate-900/50 rounded-2xl relative overflow-hidden group">
            ...
            <div className="p-6 font-mono text-sm space-y-4 text-slate-400">
              ...
              <div className="pl-6">
                ...
                <span className="text-green-400">&apos;Ayush Gupta&apos;</span>,
              </div>
              <div className="pl-6">
              ...
              <div className="pl-6">
                <span className="text-slate-500">currentFocus:</span>{" "}
                <span className="text-green-400">
